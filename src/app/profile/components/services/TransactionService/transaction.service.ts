...
export class TransactionService {
	...
	getBuyerTransaction(buyerId: number): Observable<HttpResponse<OrderModel[]>> {
		...
		return this.httpClient.get<OrderModel[]>(`${this.apiURL}/Order/transaction/buyer`, {
			params: params,
			observe: 'response'
		})
	}
	...
	getSellerTransaction(sellerId: number): Observable<HttpResponse<OrderModel[]>> {
		...
		return this.httpClient.get<OrderModel[]>(`${this.apiURL}/Order/transaction/seller`, {
			params: params,
			observe: 'response'
		})
	}
	getBuyedTransactionDetail(orderId: number): Observable<HttpResponse<OrderModel>> {
		return this.httpClient.get<OrderModel>(`${this.apiURL}/Order/transaction/buyer/${orderId}`, {
			observe: 'response'
		})
	}

	getSelledTransactionDetail(orderId: number): Observable<HttpResponse<OrderModel>> {
		return this.httpClient.get<OrderModel>(`${this.apiURL}/Order/transaction/seller/${orderId}`, {
			observe: 'response'
		})
	}
}
